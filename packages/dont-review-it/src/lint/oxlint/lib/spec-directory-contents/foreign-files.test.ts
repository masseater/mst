...
import { DEFAULT_ASSETS_NAME_MARKERS } from "../spec-syntax/assets-files.ts";
import { DEFAULT_SPEC_DIRECTORY_NAMES } from "../spec-syntax/spec-directories.ts";
...
const CONVENTION = {
  specDirectoryNames: new Set(DEFAULT_SPEC_DIRECTORY_NAMES),
  specFileSuffixes: DEFAULT_SPEC_FILE_SUFFIXES,
  assetsNameMarkers: new Set(DEFAULT_ASSETS_NAME_MARKERS),
};
