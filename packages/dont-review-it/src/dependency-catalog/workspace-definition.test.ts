...
describe("parseWorkspaceDefinition", () => {
  describe("a definition carrying package patterns, a default catalog, and a named catalog", () => {
    const it = test.extend("definition", () =>
  ...
  describe("a packages field holding an entry that is not a string", () => {
    ...
    it("drops the package patterns that are not strings", ({ definition }) => {
      expect(definition).toStrictEqual({
        packagePatterns: ["packages/*"],
        catalogEntries: [],
        catalogReferencingOverrides: [],
  ...
  describe("a packages field that is not a sequence", () => {
    ...
    it("reads as no patterns", ({ definition }) => {
      expect(definition).toStrictEqual({
        packagePatterns: [],
        catalogEntries: [],
        catalogReferencingOverrides: [],
  ...
  describe("a catalog entry whose version is not a string", () => {
    ...
    it("drops the catalog entry", ({ definition }) => {
      expect(definition).toStrictEqual({
        packagePatterns: [],
        catalogEntries: [],
        catalogReferencingOverrides: [],
  ...
  describe("overrides pointing at the catalog beside one that does not", () => {
    ...
    it("collects the override targets that point back into the catalog", ({ definition }) => {
      expect(definition).toStrictEqual({
        packagePatterns: [],
        catalogEntries: [],
  ...
  describe("an override pointing at a named catalog", () => {
    ...
    it("keeps the name of the catalog the override references", ({ definition }) => {
      expect(definition).toStrictEqual({
        packagePatterns: [],
        catalogEntries: [],
  ...
  describe("the key of an override that points at the catalog", () => {
    ...
    describe("a name carrying a version qualifier", () => {
      ...
      it("loses the version qualifier", ({ definition }) => {
        expect(definition).toStrictEqual({
          packagePatterns: [],
          catalogEntries: [],
          catalogReferencingOverrides: [{ catalogName: "", dependencyName: "vite" }],
    ...
    describe("a scoped name carrying a version qualifier", () => {
      ...
      it("loses the version qualifier and keeps the scope", ({ definition }) => {
        expect(definition).toStrictEqual({
          packagePatterns: [],
          catalogEntries: [],
          catalogReferencingOverrides: [{ catalogName: "", dependencyName: "@scope/vite" }],
    ...
    describe("a parent-child selector", () => {
      ...
      it("reads the child as the target", ({ definition }) => {
        expect(definition).toStrictEqual({
          packagePatterns: [],
          catalogEntries: [],
          catalogReferencingOverrides: [{ catalogName: "", dependencyName: "vite" }],
    ...
    describe("a range whose operator spells > inside the version qualifier", () => {
      ...
      it("keeps the name before the qualifier as the target", ({ definition }) => {
        expect(definition).toStrictEqual({
          packagePatterns: [],
          catalogEntries: [],
          catalogReferencingOverrides: [{ catalogName: "", dependencyName: "vite" }],
    ...
    describe("a spaced > between a parent and a child", () => {
      ...
      it("reads the > as part of the version range the way pnpm does", ({ definition }) => {
        expect(definition).toStrictEqual({
          packagePatterns: [],
          catalogEntries: [],
