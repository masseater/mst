...
- Options: no
- Bundle: `core`
- Source: [`no-unordered-import--group-by-origin-then-sort-by-specifier.ts`](../../src/lint/oxlint/rules/core/no-unordered-import--group-by-origin-then-sort-by-specifier.ts)
