...
- Options: yes
- Bundle: `core`
- Source: [`forbid-unresolvable-module-specifier--write-a-statically-resolvable-specifier.ts`](../../src/lint/oxlint/rules/core/forbid-unresolvable-module-specifier--write-a-statically-resolvable-specifier.ts)
