...
const resolveText = (input: ResolveInput): string | null => {
...
const declaratorsIn = (statement: UnknownFields): readonly UnknownFields[] => {
...
const moduleConstantsIn = (statements: readonly UnknownFields[]): ConstantsByName =>
  new Map(
