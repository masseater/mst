    ...
    const it = test
      ...
      .extend("theResidentMemoryOfAFastWriter", async ({}, { onCleanup }) => {
        ...
        const sampledBytes = (): number => {
          ...
          const kiloBytes = Math.trunc(Number(sampled.stdout.trim()));
