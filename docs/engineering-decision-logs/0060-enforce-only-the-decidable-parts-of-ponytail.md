# 0060. Ponytail のうち違反状態を決定できる部分だけを強制する
...
[強制の機構](../guidelines/enforcement.md) は、機械で一意に判定できる違反にガードを置き、破られた不変条件と修正の方向を報告することを求める。[0058](0058-separate-the-violation-from-the-choice-of-repair.md) は、修正案が複数あることを理由に違反を成功へ読み替えない。
